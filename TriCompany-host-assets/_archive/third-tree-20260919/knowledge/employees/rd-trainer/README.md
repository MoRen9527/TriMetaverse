# rd-trainer Employee Knowledge Workspace

- objectSetId: rd-trainer-knowledge-workspace-v0.1
- workspaceKind: employee
- workspaceId: rd-trainer
...
Employee-instance working knowledge for the current RAndDTrainer.
