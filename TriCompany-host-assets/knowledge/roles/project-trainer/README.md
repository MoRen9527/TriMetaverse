# project-trainer Role Knowledge Workspace
...
Role-level reusable training knowledge for ProjectTrainer. This is a legacy compatibility object set; the current canonical employee/source kit is `rd-trainer`.
