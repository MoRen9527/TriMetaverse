...
const suites = ['01-init-chain', '03-sync', '04-git', '08-verify', '10-portability', '11-maintainability', '05-concurrent', '06-failure', '07-cross-reset', '09-agents-conflict', '02-reset']; // 02-reset 破坏性（清链）放尾——首轮教训：reset 先跑污染 sync 前置
