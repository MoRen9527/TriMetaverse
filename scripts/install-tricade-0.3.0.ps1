# install-tricade-0.3.0.ps1
#  TriCade Bundle 0.3.0CC + Session persistence + 5 bugfix
# Right-click -> Run as administrator PowerShell
$ErrorActionPreference = "Stop"

$MSI   = "D:\OneDrive\Code\ai\vscodium\build\windows\msi\releasedir\TriCade-Bundle-x64-0.3.0.msi"
...
Write-Host "===  TriCade Bundle 0.3.0CC + Session persistence + RegRun===" -ForegroundColor Cyan
...
# 2.  MSI
Write-Host "[2/6] msiexec  0.3.0 ..." -ForegroundColor Yellow
$log = "$env:TEMP\tricade-0.3.0-install.log"
...
# 6. 
Write-Host "`n[6/6] Install completeTriCade Bundle 0.3.0 deployed:" -ForegroundColor Green
