# install-tricade-0.2.7.ps1
# 以管理员身份运行：安装 TriCade Bundle 0.2.7（含 4 个 bug 修复）
# 用法：右键 -> 以管理员身份运行 PowerShell，执行本脚本
$ErrorActionPreference = "Stop"

$MSI   = "D:\OneDrive\Code\ai\vscodium\build\windows\msi\releasedir\TriCade-Bundle-x64-0.2.7.msi"
...
Write-Host "=== 安装 TriCade Bundle 0.2.7（含 4 bug 修复）===" -ForegroundColor Cyan
...
# ── 2. 安装 MSI ──
Write-Host "[2/4] msiexec 安装 0.2.7 ..." -ForegroundColor Yellow
$log = "$env:TEMP\tricade-0.2.7-install.log"
