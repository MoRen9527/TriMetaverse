...
| Tride | Bun/TS monorepo | bun turbo test + Playwright（按 package） | 已有 CI 流程 |
...
- 现状：
  ...
  - Tride：已有较完整 test/typecheck/e2e。
...
- Tride：将现有 test workflow 指标纳入统一看板
