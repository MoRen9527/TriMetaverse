...
- supportPublishedCopy: TriCompany-host-assets/docs/engineering/STATE.md
...
- 项目真源文档同步已落地 `source_publish_check --project-docs` DCE、manifest、安全门与 43 项回归；完整 FADE 的事件触发、持久 run/checkpoint、Plan / Close Skill、Close CLI、Signal 与恢复 worker 尚未实现
