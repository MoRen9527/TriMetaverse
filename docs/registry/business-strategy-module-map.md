...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `TriMetaverse` | 总商业模式、阶段、workflow、虚拟公司规则与中央边界真源 | 任何战略、阶段、运行边界和模块取舍问题 | 高 | 中央先经 `BusinessStrategy` 判范围；模块内由 `TriMetaverseBusinessStrategyRegistry` | `TriMetaverseProductRegistry` | `TriMetaverseCodeRegistry` | `../../tmv-whitepaper.md`, `../../project.md`, `../../cyber-company.md` |
