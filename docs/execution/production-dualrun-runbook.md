...
| 5 | UAC 提权安装 | 管理员权限 | **done**（CEO 2026-08-13 11:08 执行：v0.4.4 覆盖安装 + schtasks "TriLC Daemon" 注册；2026-08-14 CEO 重启闭环：shutdown + RegRun 清理 + schtasks /run → version 0.4.4 + count 14 + connected 恢复——运营日确认） |
