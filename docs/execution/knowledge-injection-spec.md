...
上位规范：[TriCompany FADE 协议（v2.0.0 前称 ADE）](../../TriCompany/docs/engineering/fade-protocol-spec.md) + [ade-consolidation-proposal.md](../../TriCompany/docs/engineering/ade-consolidation-proposal.md)（双部署模型：runtime 侧知识形态）
