...
**命名即语义**：M/R=面，L=Local（本地域），第二字母位 M=服务域 Machine——四名四角色（TriMMC/TriMLC/TriRMC/TriRLC），无「新旧版本」关系。
