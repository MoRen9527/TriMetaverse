...
当前 machine-readable host object 清单位于 `TriCompany-copilot-host-assets/host-object-manifest.json`。
...
| 支撑包 vendor/reference | `TriCompany-copilot-host-assets/vendor/reference/**` | 当前是宿主支撑副本 | 保留为支撑副本 | `source-only` | 后续核对是否与源仓一致，不在支撑包独立演化 |
...
1. `TriCompany-copilot-host-assets/docs/` 下所有 published-copy 文档已于 2026-07-08 删除；agent/prompt 前置核查已直接读取 `TriCompany/docs/` 源侧。
