...
- 判据数据源（0923 校准·总攻件④）: **双源取新**——树上任务书截点+COO/COS 变更通报；凡截点顺延/取消/变更经 COS→COO→sg 值席通报链显式广播，值席更新白名单（/home/fleet/.duty-urge-whitelist.json，现役 4 条：LG-046 取消/LG-051 改 09-24 12:00/core-agent 终批/LG-039 明晨窗）后再判逾期。
