...
- **P4 窗下限（CTO 排布意见终版）**：P4 窗不得早于 **09-10 下午（切指后 ≥27h）**，**09-11 全天最稳**——观察期内 8711 观测扰动会污染「无 degraded 误报」读数归因（P4 操作与观察期读数须时序隔离）
- **冻结条款**：**切指后 24h 内 P4 线零触 8711**（与迁移窗冻结 watcher 同款保护律——观察期读数纯度保护）
